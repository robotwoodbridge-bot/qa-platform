...
...                - Infra stack up: cd infrastructure/environments/local && terraform apply
...                - ./scripts/run_security.sh [environment]
...
...              Override target: docker exec qa-platform-security-runner robot --variable ENVIRONMENT:production tests/
