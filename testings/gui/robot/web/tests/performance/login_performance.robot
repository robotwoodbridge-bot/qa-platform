...
...
...              Concurrency counterpart: testings/performance/k6/scripts/login_load_test.js
...              (this suite measures one user's experience; k6 measures behavior under load).
...
...              Thresholds are suite variables — override per-run, e.g.:
...              ./scripts/run_robot_web.sh performance -- --variable LOGIN_SLA_MS:3000
Resource         ../../resources/test_data.robot
Resource         ../../resources/common.robot
Resource         ../../pages/login_page.robot
Resource         ../../../shared/resources/reporting.robot
Library          DateTime
Library          Collections
